...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-qq"></i>Cattle Breed Management</b></h5>
  </header>
	 ...
	 <div class="w3-row">
	 	...
	 	<div class="col-md-6">
	 		...
	 		<table class="table table-hover table-bordered" id="table">
	 			...
	 			<tbody>
	 				<?php
                                         //Here the SQL query will display all the contents of the breed table containing the cattle breeds
	 	...
	 	<div class="col-md-6">
	 		<div class="panel panel-primary" >
	 			<div class="panel-heading w3-yellow">Add a new Cattle Breed</div>
	 			<div class="panel-body">
	 				<form method="post">
	 					...
	 					<button class="btn btn-sm btn-default" type="submit" name="submit">Add Breed</button>

	 					<?php 
                                                //Here the NEW breeds will be added to the breeds data base
