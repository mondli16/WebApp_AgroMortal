...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Stock Management > Add</b></h5>
  </header>
 ...
 <div class="w3-row">
 	...
 	<div class="col-md-6">
      ...
      if(isset($_POST['submit']))
      {
      	...
      	$insert = $db->query("INSERT INTO pigs(pigno,weight,arrived,breed_id,remark,health_status,img,gender,Price,breed) VALUES('$n_pigno','$n_weight','$n_arrived','$n_pigno','$n_remark','$n_status','$path1','$n_gender','$n_Prc','$n_breed') ");

      	if($insert){?>
      	<div class="alert alert-success alert-dismissable">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
             <strong>Stock successfully added <i class="fa fa-check"></i></strong>
        </div>
       <?php
      	}else{ ?>
     ...
     ?>
 		...
 		<form method="post" autocomplete="off" enctype="multipart/form-data">
 			<div class="form-group">
	 			<label class="control-label">Stock No.</label>
	 			<input type="text" name="pigno" class="form-control" value="<?php echo mt_rand(0000,9999); ?>" readonly="on" required>
	 		</div>

	 		<div class="form-group">
	 			<label class="control-label">Stock Weight</label>
	 			<input type="text" name="weight" class="form-control" required>
	 		</div>

	 		<div class="form-group date" data-provide="datepicker">
	 			<label class="control-label">Arrival/Harvest date</label>
	 		...
	 		<div class="form-group">
	 			<label class="control-label">Stock photo</label>
